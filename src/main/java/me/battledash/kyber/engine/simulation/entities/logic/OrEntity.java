...
import me.battledash.kyber.types.pojo.entities.OrEntityData;

@Slf4j
@FrostbiteEntity(OrEntityData.class)
public class OrEntity extends EntityWithBusAndData<OrEntityData> {

    public OrEntity(EntityCreationInfo info, OrEntityData data) {
        super(info, data);
    }
